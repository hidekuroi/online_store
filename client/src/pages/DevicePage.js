...
const device = {id: 1, name: "IPhone 14 Pro", price: 1199, rating: 5, img: "https://my-apple-store.ru/wa-data/public/shop/products/30/26/12630/images/19824/19824.970.jpg"}
const description = [
  {id: 1, title: 'Оперативная память', description: '8гб'},
  {id: 2, title: 'Камера', description: '48мп, 12мп, 12мп'},
  {id: 3, title: 'Процессор', description: 'Apple A16'},
  {id: 4, title: 'Экран', description: '6.1\''},
  {id: 5, title: 'Аккумулятор', description: '3100mah'}
]
